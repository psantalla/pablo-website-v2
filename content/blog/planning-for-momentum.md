...
description: When the day disappears into a single task, planning ahead is the only thing that brings momentum back, even when chaos rearranges the plan.
date: 2026-05-29
tags:
draft: false
---
...
- I set an actual timer. Same outcome. It’s basically the equivalent of remembering that half an hour has passed in the previous example. I’m not sure why I thought a sound would somehow change the situation.

- I plan ahead. It’s the only thing that actually works, but it’s tricky. More on that in a second.
